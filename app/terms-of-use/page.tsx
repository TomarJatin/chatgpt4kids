  ...
  return (
    <article className="prose mx-auto my-10 px-6">
      <h1 className="text-3xl font-bold text-black text-center">
        ChatGPT for Kids Terms of Use
      </h1>
      <p>
        <strong>Version 1.0</strong>
      </p>
      <p>
        <strong>Last revised on: 2025-03-23</strong>
      </p>

      <p>
        The website located at{" "}
        <Link href="https://chatgpt4kids.com">
          <strong>chatgpt4kids.com</strong>
        </Link>{" "}
        (the “Site”) is a work belonging to ChatGPT for Kids (“Company”, “us”,
        ...
        and rules are guidelines, and rules are incorporated by reference into
        these Terms.
      </p>
      ...
      <p>
        ...
        prompted by the account registration form. You represent and warrant
      ...
      <p>
        ...
        occur under your Account. You agree to immediately notify Company of any
      ...
      <p>
        ...
        product, or service; and (d) except as expressly stated herein, no part
        ...
        All copyright and other proprietary notices on the Site (or on any
      ...
      <p>
        ...
        party for any modification, suspension, or discontinuation of the Site
        or any part thereof.
      </p>
      ...
      <p>
        ...
        Site (“Feedback”), you hereby assign to Company all rights in such
      ...
      <p>
        ...
        submits to, or uses with, the Site (e.g., content in the user’s profile
        ...
        disclosure of your User Content that personally identifies you or any
        third party. You hereby represent and warrant that your User Content
        does not violate our Acceptable Use Policy (defined in Section 3.3). You
        ...
        if, for example, your User Content violates the Acceptable Use Policy.
      ...
      <h3>3.3 Acceptable Use Policy.</h3>
      ...
      <ul>
        ...
        <li>
          ...
          (vii) use software or automated agents or scripts to produce multiple
      ...
      <h3>3.4 Enforcement.</h3>
      <p>
        We reserve the right (but have no obligation) to review, refuse and/or
        remove any User Content in our sole discretion, and to investigate
      ...
      <h2>5. Third-Party Links &amp; Ads; Other Users</h2>
      <h3>5.1 Third-Party Links &amp; Ads.</h3>
      <p>
        ...
        Links &amp; Ads”). Such Third-Party Links &amp; Ads are not under the
      ...
      <p>
        ...
        Content. Since we do not control User Content, you acknowledge and agree
        that we are not responsible for any User Content, whether provided by
        you or by others. We make no guarantees regarding the accuracy,
        currency, suitability, appropriateness, or quality of any User Content.
      ...
      <p>
        ...
        termination of your rights under these Terms, including for termination
        of your Account or deletion of your User Content. Even after your rights
        under these Terms are terminated, the following provisions of these
        Terms will remain in effect: Sections 2.2 through 2.6, Section 3 and
      ...
      {/* <p>
        <em>
          *Please fill in the following fields once you have registered with the
          Copyright Office and delete the yellow highlighted text:*
        </em>
      </p>
      <p>
        The designated Copyright Agent for Company is: _________ <br />
        Designated Agent: _________ <br />
        Address of Agent: _________ <br />
        Telephone: _________ <br />
        Fax: _________ <br />
        Email: _________
      </p> */}
      ...
      <h4>10.2(a) Applicability of Arbitration Agreement.</h4>
      <p>
        You agree that any dispute between you and any of the Company Parties
        relating in any way to the Site, the services offered on the Site (the
        ...
        survive the expiration or termination of these Terms and shall apply,
        without limitation, to all claims that arose or were asserted before you
        agreed to these Terms (in accordance with the preamble) or any prior
        version of these Terms. This Arbitration Agreement does not preclude you
        from bringing issues to the attention of federal, state or local
        agencies. Such agencies can, if the law allows, seek relief against the
        Company Parties on your behalf. For purposes of this Arbitration
        Agreement, “Dispute” will also include disputes that arose or involve
        facts occurring before the existence of this or any prior versions of
        the Agreement as well as claims that may arise after the termination of
        these Terms.
      </p>

      <h4>10.2(b) Informal Dispute Resolution.</h4>
      <p>
        There might be instances when a Dispute arises between you and Company.
        If that occurs, Company is committed to working with you to reach a
        reasonable resolution. You and Company agree that good faith informal
        efforts to resolve Disputes can result in a prompt, low‐cost and
        mutually beneficial outcome. You and Company therefore agree that before
      ...
      <p>
        ...
        admin(-at-)chatgpt4kids.com. The Notice must include: (1) your name,
      ...
      <h4>10.2(c) Arbitration Rules and Forum.</h4>
      <p>
        ...
        Resolution Process described above does not resolve satisfactorily
        within 60 days after receipt of your Notice, you and Company agree that
        ...
        with an amount in controversy under $250,000, not inclusive of
        attorneys’ fees and interest, shall be subject to JAMS’ most current
        ...
        <a href="http://www.jamsadr.com/">www.jamsadr.com</a> or by calling JAMS
        at 800-352-5267. A party who wishes to initiate arbitration must provide
      ...
      <h4>10.2(d) Authority of Arbitrator.</h4>
      <p>
        The arbitrator shall have exclusive authority to resolve all disputes
        subject to arbitration hereunder including, without limitation, any
        ...
        arising out of or relating to the subsection entitled “Waiver of Class
        or Other Non-Individualized Relief,” including any claim that all or
        part of the subsection entitled “Waiver of Class or Other
        Non-Individualized Relief” is unenforceable, illegal, void or voidable,
        or that such subsection entitled “Waiver of Class or Other
      ...
      <h4>10.2(e) Waiver of Jury Trial.</h4>
      <p>
        <strong>
      ...
      <h4>10.2(f) Waiver of Class or Other Non-Individualized Relief.</h4>
      <p>
        <strong>
          YOU AND COMPANY AGREE THAT, EXCEPT AS SPECIFIED IN SUBSECTION 10.2(h)
          ...
          REPRESENTATIVE, OR MASS ACTION BASIS.
        </strong>{" "}
        ...
        conditions under the Subsection 10.2(h) entitled “Batch Arbitration.”
        ...
        California. All other Disputes shall be arbitrated or litigated in small
        claims court. This subsection does not prevent you or Company from
        participating in a class-wide settlement of claims.
      </p>

      <h4>10.2(g) Attorneys’ Fees and Costs.</h4>
      <p>
      ...
      <h4>10.2(h) Batch Arbitration.</h4>
      <p>
      ...
      <h4>10.2(i) 30-Day Right to Opt Out.</h4>
      <p>
        ...
        to the following address: admin(-at-)chatgpt4kids.com, within 30 days
      ...
      <h4>10.2(j) Invalidity, Expiration.</h4>
      <p>
      ...
      <p>
        ...
        becoming effective by writing Company at the following address:
        admin(-at-)chatgpt4kids.com. Unless you reject the change within 30 days
      ...
      <h3>10.5 Electronic Communications.</h3>
      <p>
      ...
      <h3>10.7 Copyright/Trademark Information.</h3>
      <p>
        Copyright © 2025 ChatGPT for Kids. All rights reserved. All trademarks,
      ...
      <p>
        ...
        Email: admin(-at-)chatgpt4kids.com
      </p>
