            ...
            <div className="flex flex-col pt-3 lg:pt-3 space-y-4">
              <div className="space-y-6">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl mb-0 pb-0">
                  Don&apos;t let your child use regular ChatGPT as a shortcut—
                  copying homework robs them of essential learning and growth.
                </p>
                <p className="max-w-[600px] text-muted-foreground md:text-xl mt-0 pt-0">
                  ...
                  as a personal tutor that sparks curiosity, builds critical
                  thinking, and unlocks real understanding.
                </p>
                <p className="max-w-[600px] text-muted-foreground md:text-xl mt-0 pt-0">
                  In homework mode, we never give answers straight out. We
                  transform routine assignments into an interactive learning
                  adventure—guiding your child step by step, deepening their
                  knowledge, and inspiring a lifelong love of learning.
                </p>
              </div>
